...
if ($('.mobile-menu').length) {
	...
	$('.menu-backdrop, .mobile-menu .close-menu').on('click', function () {
		$('body').removeClass('mobile-menu-visible');
	});
}
...
=============================================*/
function mainSlider() {
	console.log('main slider called');
...
$('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
	$(".ucm-active2").trigger('refresh.owl.carousel');
});
...
// 	var movie_id = $(this).closest('.movie-poster').find('input[name="movie_id"]').val();
